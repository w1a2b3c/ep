	...
	$("#listTable").bootstrapTable({
		...
		columns: [
			...
			},
			{
				...
				formatter: function(value, row, index) {
					return row.typename ? '<img src="/assets/icon/'+row.typename+'.ico" class="type-logo" onerror="this.style.display=\'none\'">'+row.typeshowname+'(<a href="./pay_channel.php?kw='+row.channel+'" target="_blank">'+row.channel+'</a>)<br/>'+row.plugin : '';
				}
			},
			{
				field: 'ip',
